...
def append_untrusted_hosts(destination):
    ...
    for line in args.untrusted_hosts:
        ...
        if line != "" and line[0] != "#" and result.get(line) == None:
...
def append_external_hosts(destination, untrusted):
...
def main():
    ...
    untrusted = append_untrusted_hosts(tmpFile)
    append_external_hosts(tmpFile, untrusted)
